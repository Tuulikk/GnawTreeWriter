# Installation Bug Report: cargo install fails on Fedora

## Problem Description

`cargo install --git https://github.com/Tuulikk/GnawTreeWriter.git` fails with segmentation faults in both GCC and rustc compilers. This prevents installation via cargo, though the code builds successfully locally.
...
### NOT a GnawTreeWriter Code Issue
